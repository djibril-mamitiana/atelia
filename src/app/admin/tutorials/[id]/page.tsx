...
export default async function EditTutorialPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      <h1 className="font-display text-2xl text-ink">Modifier « {tutorial.title} »</h1>
      <div className="mt-6">
        <TutorialForm
      ...
      {tutorial.products.length > 0 && (
        <div className="mt-6 rounded-md border border-border bg-surface p-4">
          <p className="mb-2 text-sm font-medium text-ink">Produits actuellement liés (pour référence des IDs) :</p>
